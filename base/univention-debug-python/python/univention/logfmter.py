...
from typing import Any, Dict, List, Optional, Tuple, Type, cast  # noqa: UP035


ExcInfo = Tuple[Type[BaseException], BaseException, TracebackType]  # noqa: UP006

# Reserved log record attributes cannot be overwritten. They
# will not be included in the formatted log.
#
# https://docs.python.org/3/library/logging.html#logrecord-attributes
RESERVED: Tuple[str, ...] = (  # noqa: UP006
    "args",
    "asctime",
    "created",
    "exc_info",
...
class Logfmter(logging.Formatter):
    ...
    def format_string(cls, value: str) -> str:
        ...
        if needs_quoting:
            value = '"{}"'.format(value)  # noqa: UP032

        return value if value else ""  # noqa: FURB110
    ...
    def format_params(cls, params: dict) -> str:
        ...
        return " ".join(
            [
                "{}={}".format(key, cls.format_value(value))  # noqa: UP032
    ...
    def __init__(
        self,
        keys: List[str] = ["at"],  # noqa: UP006
        mapping: Dict[str, str] = {"at": "levelname"},  # noqa: UP006
        datefmt: Optional[str] = None,  # noqa: UP045
    ):
    ...
    def format(self, record: logging.LogRecord) -> str:
        ...
        for key in self.keys:
            ...
            tokens.append("{}={}".format(key, self.format_value(value)))  # noqa: UP032
        ...
        if record.exc_info:
            ...
            tokens.append("exc_info={}".format(self.format_exc_info(exc_info)))  # noqa: UP032
