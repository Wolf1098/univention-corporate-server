...
"""|UDM| module for all |authorization| objects"""
...
module = 'authorization/all'

childs = False
short_description = _('All authorization objects')
object_name = _('Authorization')
object_name_plural = _('Authorizations')
long_description = _('Manage the authorization objects')
operations = ['search']
childmodules = ['authorization/policy', 'authorization/privilege']
virtual = True
